...
const KODE_FILE = 'SBM.PD-1-6-2026';
...
const INVOICE_TARGETS = [
    { stage: 1, label: 'Tahap pertama', invoiceDate: '2026-02-06' },
    { stage: 2, label: 'Tahap kedua', invoiceDate: '2026-09-03' }
];
...
async function main() {
    ...
    const terms = [...INVOICE_TARGETS, ...PAYMENT_TARGETS]
    ...
    const paymentPlans = PAYMENT_TARGETS.map(target => {
        ...
        return { ...item, target, existing, bkmNumber: '' };
    });
