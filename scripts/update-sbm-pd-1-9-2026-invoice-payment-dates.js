...
const KODE_FILE = 'SBM.PD-1-9-2026';
...
const INVOICE_TARGETS = [
    { stage: 1, label: 'Tahap pertama', invoiceDate: '2026-02-12' },
    { stage: 2, label: 'Tahap kedua', invoiceDate: '2026-06-17' },
    { stage: 3, label: 'Tahap ketiga', invoiceDate: '2026-08-21' }
];

const PAYMENT_TARGETS = [
    { stage: 1, label: 'Tahap pertama', paymentDate: '2026-03-03' },
    { stage: 2, label: 'Tahap kedua', paymentDate: '2026-06-30' }
];
